...
(function (GateType) {
    ...
    GateType[GateType["Token"] = 0] = "Token";
    /** NFT collection check via Metaplex metadata verification */
    GateType[GateType["Collection"] = 1] = "Collection";
...
const manageTableCreatorsInstruction = (builder, accounts, args) => builder.build("manage_table_creators", accounts, args);
exports.manageTableCreatorsInstruction = manageTableCreatorsInstruction;
const onboardTableInstruction = (builder, accounts, args) => builder.build("onboard_table", accounts, args);
exports.onboardTableInstruction = onboardTableInstruction;
...
const reallocAccountInstruction = (builder, accounts, args) => builder.build("realloc_account", accounts, args);
exports.reallocAccountInstruction = reallocAccountInstruction;
...
const dbCodeInInstruction = (builder, accounts, args, remainingAccounts) => {
