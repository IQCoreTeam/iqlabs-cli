...
export declare const manageTableCreatorsInstruction: (builder: InstructionBuilder, accounts: {
    signer: PublicKey;
    db_root: PublicKey;
    system_program?: PublicKey;
}, args: {
...
export declare const onboardTableInstruction: (builder: InstructionBuilder, accounts: {
    signer: PublicKey;
    db_root: PublicKey;
}, args: {
    db_root_id: Bytes;
...
export declare const reallocAccountInstruction: (builder: InstructionBuilder, accounts: {
    payer: PublicKey;
    target: PublicKey;
    system_program?: PublicKey;
}, args: {
...
export declare const dbCodeInInstruction: (builder: InstructionBuilder, accounts: {
    ...
    metadata: string;
    session: SessionFinalize | null;
}, remainingAccounts?: PublicKey[]) => TransactionInstruction;
